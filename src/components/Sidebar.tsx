...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, toggleSidebar }) => {
  ...
  return (
    ...
    >
            ...
            .map((tab) => {
              ...
              return (
                <li key={tab}>
                  ...
                  >
                    <div
                      className={`flex-shrink-0 ${isActive && !isCollapsed ? "animate-bounce-subtle" : ""}`}
                    >
                      {getIconForTab(tab)}
                    </div>
                    <span
      ...
      <div
        className={`border-t border-gray-200 dark:border-gray-700 space-y-2 ${isCollapsed ? "p-2" : "p-4"}`}
      >
        <button
