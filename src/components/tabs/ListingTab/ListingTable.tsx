...
export default function ListingTable({ accountId, onBack, initialTab = 'new' }: ListingTableProps) {
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-end border-b border-gray-200 mb-6 gap-4">
              ...
              `}
                ...
                <div className="flex items-center gap-4 py-2 pb-3">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className="p-1 px-2 border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed text-xs flex items-center gap-1"
                            title="Previous Page"
                        >
                            ...
                            >
                                ...
                                <div className="p-4 flex flex-col flex-grow">
                                    ...
                                    <button
                                        ...
                                        className="block w-full text-center py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors mt-auto"
                                    >
                                        View on Etsy
                                    </button>
                                </div>
