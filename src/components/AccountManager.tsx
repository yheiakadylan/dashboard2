...
const ReSyncModal: React.FC<ReSyncModalProps> = ({ isOpen, onClose, account, onConfirm }) => {
...
const BulkQuickSyncModal: React.FC<BulkQuickSyncModalProps> = ({ isOpen, onClose, accounts, onConfirm }) => {
