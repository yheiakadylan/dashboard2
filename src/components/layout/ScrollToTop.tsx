...
const ScrollToTop = () => {
    ...
    const activeScrollTargetRef = useRef<Element | Window | null>(null);
    ...
    useEffect(() => {
        const handleScroll = (e: Event) => {
            ...
            if (currentScrollTop > 300 && isScrollingUp) {
                activeScrollTargetRef.current = currentTarget;
                setIsVisible(true);
                ...
                if (currentTarget === activeScrollTargetRef.current) {
                    setIsVisible(false);
