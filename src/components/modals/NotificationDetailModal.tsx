...
const NotificationDetailModal: React.FC<Props> = ({ notification, onClose, userProfile, accounts = [] }) => {
    ...
    const canViewFunds = userProfile?.role === 'owner' || userProfile?.permissions.viewKpiFunds === true;
    ...
    const renderCaseHelpContent = () => {
        const caseId = notification.metadata.case_id || notification.metadata.order_id;
        const caseType = notification.metadata.case_type || notification.metadata.help_kind || notification.type;
        ...
        const subject = notification.metadata.subject || caseType;
        const message = notification.metadata.message || notification.metadata.case_msg || notification.content;
