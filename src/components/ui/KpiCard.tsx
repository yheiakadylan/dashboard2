...
const ConversionModal = React.lazy(() => import('../modals/ConversionModal').then(module => ({
  default: module.ConversionModal,
})));
          ...
          {'value' in displayValue && typeof displayValue.value === 'string' ? (
            <div className="flex flex-col gap-1">
              <div className="flex items-baseline gap-2">
                ...
                {isModalOpen && (displayValue as KpiValue).conversionDetails && (
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    {/* Conversion Modal */}
                    {isModalOpen && usdTotal.conversionDetails && (
                      <React.Suspense fallback={null}>
                        <ConversionModal
                          isOpen
                          onClose={() => setIsModalOpen(false)}
