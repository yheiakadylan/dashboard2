...
const KpiCard: React.FC<KpiCardProps> = ({ title, value }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 flex items-start gap-4 transition-transform hover:-translate-y-1 duration-200">
